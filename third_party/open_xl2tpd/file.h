...
#define DEFAULT_AUTH_FILE "/usr/local/data/tmp/xl2tpd/l2tp-secrets"
#endif
#ifndef DEFAULT_CONFIG_FILE
#define DEFAULT_CONFIG_FILE "/usr/local/data/tmp/xl2tpd/xl2tpd.conf"
#endif
#define ALT_DEFAULT_AUTH_FILE "/usr/local/data/tmp/l2tpd/l2tp-secrets"
#define ALT_DEFAULT_CONFIG_FILE "/usr/local/data/tmp/l2tp/l2tpd.conf"
#define DEFAULT_PID_FILE "/usr/local/data/tmp/xl2tpd.pid"
