...
{
    struct timespec tv;          /* Scheduled time to execute */
...
struct schedule_entry *aschedule (struct timespec tv, void (*func) (void *),
                                  void *data);
...
struct timespec *process_schedule(struct timespec *);
