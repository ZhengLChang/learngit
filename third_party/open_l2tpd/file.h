...
#define ALT_DEFAULT_AUTH_FILE "/var/l2tpd/l2tp-secrets"
#define DEFAULT_CONFIG_FILE "/var/l2tp/l2tpd.conf"
#define ALT_DEFAULT_CONFIG_FILE "/var/l2tpd/l2tpd.conf"
#define DEFAULT_PID_FILE "/var/run/l2tpd.pid"
#else
#define DEFAULT_AUTH_FILE "/usr/local/data/tmp/l2tp/l2tp-secrets"
#define ALT_DEFAULT_AUTH_FILE "/var/l2tpd/l2tp-secrets"
#define DEFAULT_CONFIG_FILE "/usr/local/data/tmp/l2tp/l2tpd.conf"
#define ALT_DEFAULT_CONFIG_FILE "/var/l2tpd/l2tpd.conf"
#define DEFAULT_PID_FILE "/usr/local/data/tmp/l2tp/run/l2tpd.pid"
#endif
