...
//added by yuemalin for rtl8363NB, vlan filter status or get vlan filter status
rtk_api_ret_t rtk_set_vlan_status(rtk_uint32 enble);
rtk_api_ret_t rtk_get_vlan_status(rtk_uint32 * pstatus);
