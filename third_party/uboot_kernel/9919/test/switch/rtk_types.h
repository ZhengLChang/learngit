...
#define MDC_MDIO_OPERATION		1    //added by yuemalin 
#define ATCOM_RTL8363NB				1
...
//added by yuemalin for dspg9919 set programming guide's 6.1. Ports Mapping
#ifdef ATCOM_RTL8363NB
#define ATCOM_PC_PORT			UTP_PORT1
#define ATCOM_LAN_PORT			UTP_PORT3
#define ATCOM_CPU_PORT			EXT_PORT0
#endif
